...
public:
	...
	virtual bool	GetHasCaughtPlayerPickpocketting(); //Get HasCaight
	...
	virtual bool	IsWeaponOut(); // From JIP
	virtual void	SetWeaponOut(Actor* actor, bool weaponOut); // From JIP
	...
	virtual bool	IsOnDialoguePackage(Actor* actor); // JIP
