...
public:
	...
	Tile* GetActiveTile(); ////////////////////////////////////////////////////////////////ADDED BY ME
	UInt32 GetTopVisibleMenuIDJIP();
};
...
//bool* g_menuVisibilityJIP = (bool*)0x11F308F; // From JIP
...
public:
	...
	__forceinline Tile* AddTileFromTemplate(Tile* destTile, const char* templateName) // FROM JIP GAMEUI.h
	{
