...
static ParamInfo kParams_Tomm_DebugTextSetZoom[2] =
{
	{"String", kParamType_String, 0},
	{ "float", kParamType_Float, 0 },
};
...
ParamInfo kParams_Tomm_TwoScriptVars_OneInt[3] =
{
	{"Variable", kParamType_ScriptVariable, 0},
	{"Variable", kParamType_ScriptVariable, 0},
	{"Integer", kParamType_Integer, 0},
...
ParamInfo kParams_Tomm_NifBlockInterpolateScale[7] =
{
	{"String", kParamType_String, 0}, //nif block
	{"Float", kParamType_Float, 0}, //start value
	{"Float", kParamType_Float, 0}, // end value
	{"Float", kParamType_Float, 0}, // timer
	{"Integer", kParamType_Integer, 0}, // mode
	{"Integer", kParamType_Integer, 1}, // 6 - PC NODE
	{"Integer", kParamType_Integer, 1}, // iCalculateStartValue
};

ParamInfo kParams_Tomm_NifBlockInterpolateRotation[11] =
{
	{"String", kParamType_String, 0}, //nif block
	{"Float", kParamType_Float, 0}, //StartX
	{"Float", kParamType_Float, 0}, //StartY
	{"Float", kParamType_Float, 0}, //StartZ
	{"Float", kParamType_Float, 0}, //EndX
	{"Float", kParamType_Float, 0}, //EndY
	{"Float", kParamType_Float, 0}, //EndZ
	{"Float", kParamType_Float, 0}, // timer
	{"Integer", kParamType_Integer, 0}, // mode
	{"Integer", kParamType_Integer, 1}, // PC NODE
	{"Integer", kParamType_Integer, 1}, // iCalculateStartValue
...
ParamInfo kParams_Tomm_NifBlockInterpolateTranslation[12] =
{
	{"String", kParamType_String, 0}, //nif block
	{"Float", kParamType_Float, 0}, //StartX
	{"Float", kParamType_Float, 0}, //StartY
	...
	{"Float", kParamType_Float, 0}, // timer
	{"Integer", kParamType_Integer, 0}, // mode
	{"Integer", kParamType_Integer, 0}, //World
	{"Integer", kParamType_Integer, 1}, // PC NODE
	{"Integer", kParamType_Integer, 1}, // iCalculateStartValue
};


ParamInfo kParams_Tomm_IsNifBlockInterpolated[3] =
{

	{"String", kParamType_String, 1}, //nif block
	{"Integer", kParamType_Integer, 1}, // type
	{"Integer", kParamType_Integer, 1}, // PC NODE

};

ParamInfo kParams_Tomm_NifBlockInterpolateStop[3] =
{
...
static ParamInfo kParams_Tomm_SetSUPOnInterpolateFinishEvent[2] =
{
	{"Form", kParamType_AnyForm, 0},
	{"Integer", kParamType_Integer, 1}, // Loop
};

ParamInfo kParams_Tomm_GetNifBlockNumVerticles[2] =
{
	{"String", kParamType_String, 0},
	{"int", kParamType_Integer, 1 },
};
...
ParamInfo kParams_Tomm_NifBlockInterpolateSetTrait[5] =
{
	{"Integer", kParamType_Integer, 0}, // trait
	{"Float", kParamType_Float, 0}, // value
	{"String", kParamType_String, 1}, //nif block
	{"Integer", kParamType_Integer, 1}, // type
	{"Integer", kParamType_Integer, 1}, // PC NODE
